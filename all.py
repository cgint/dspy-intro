...
if __name__ == "__main__":
    main()from typing import Any, Literal, Optional, Union, Dict
...
if __name__ == "__main__":
    main()from typing import Literal, Dict
import mlflow
...
def get_lm_for_model_name(model_name: str, reasoning_effort: Literal["low", "medium", "high", "disable"] = "disable") -> dspy.LM:
...
def main():
    ...
    with mlflow.start_run(run_name="simplest_dspy"):
        the_joke = dspy.Predict("name -> joke")(name="John").joke
        print("\n\n" + the_joke + "\n\n")
